...
#define fragDistortion(i) \
    ...
    grabPosUV = abs(grabPosUV); \
    if (grabPosUV.x / grabPosUV.w > 1) { \
        grabPosUV.x = grabPosUV.w - (grabPosUV.x - grabPosUV.w); \
    } \
    if (grabPosUV.y / grabPosUV.w > 1) { \
        grabPosUV.y = grabPosUV.w - (grabPosUV.y - grabPosUV.w); \
    } \
