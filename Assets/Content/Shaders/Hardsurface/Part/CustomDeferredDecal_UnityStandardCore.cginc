...
#include "CustomDeferredDecal_UnityStandardInput.cginc"
...
inline FragmentCommonData MetallicSetup (float4 i_tex)
{
    ...
    half3 albedo = _Color.rgb * lerp (mainTex.rgb, mainTex.rrr, _CompositeMode);
...
inline FragmentCommonData FragmentSetup (inout float4 i_tex, float3 i_eyeVec, half3 i_viewDirForParallax, float4 tangentToWorld[3], float3 i_posWorld)
{
    ...
    half4 mainTex = tex2D (_MainTex, i_tex.xy);
    half alphaMain = lerp (mainTex.a, saturate (mainTex.a + mainTex.b), _CompositeMode);

    #if defined(_ALPHATEST_ON)
        clip (alphaMain - _Cutoff);
    #endif
    ...
    o.diffColor = PreMultiplyAlpha (o.diffColor, alphaMain, o.oneMinusReflectivity, /*out*/ o.alpha);
    return o;
}
